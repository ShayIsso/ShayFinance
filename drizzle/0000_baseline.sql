...
CREATE TYPE "public"."sync_run_status" AS ENUM('success', 'otp_skipped', 'error');--> statement-breakpoint
...
CREATE TABLE "recurring_expenses" (
	...
	"expected_cadence" "recurring_cadence" NOT NULL,
...
CREATE TABLE "scheduler_config" (
	...
	"cron_time" varchar(5) DEFAULT '07:00' NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE "recurring_expenses" ADD CONSTRAINT "recurring_expenses_last_matched_txn_id_transactions_id_fk" FOREIGN KEY ("last_matched_txn_id") REFERENCES "public"."transactions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_recurring_fingerprint" ON "recurring_expenses" USING btree ("pattern_fingerprint");--> statement-breakpoint
