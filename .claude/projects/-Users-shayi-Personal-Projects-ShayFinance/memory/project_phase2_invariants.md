...
- **Category count:** 21 default Hebrew categories. History: 19 → 20 (`תחבורה ציבורית` added to seed during the post-R1 cleanup, 2026-05-01) → 21 (`הסדרה - כרטיס אשראי` added by R1, 2026-05-01). Always verify against `src/db/seed.ts` for the canonical list.
