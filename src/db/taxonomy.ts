...
export const TAXONOMY_V2: CategoryDef[] = [
  ...
  },
  {
    ...
    color: "#6366f1",
    description:
      "כולל: דלק ותחנות דלק, חניונים ודמי חניה, כבישי אגרה, תחבורה ציבורית (אוטובוס, רכבת, רב-קו), מוניות ושירותי נסיעה, וכן טיפולי רכב ומוסכים. לא כולל: ארנונה ותשלומים לרשות המקומית שאינם חניה (→ חשבונות ושירותים).",
  },
  {
    name: "דיור ושכירות",
    type: "expense",
